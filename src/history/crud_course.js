    ...
    return (
        <SafeAreaView>
            <View style={styles.header_container}>
                <Text style={styles.txt_main}>Curso {list.length}</Text>
                <TouchableOpacity
                    onPress={handleVisibleModal}

                >
                    <Text style={styles.txt_name}>Novo Curso</Text>
                </TouchableOpacity>
            </View>
            <Modal
                animationType="slide"
                    ...
                    return(
                        <View style={styles.item_course} key={index}>
                            <View>
                                ...
                                <Text style={styles.txt_item}>{item.preço}</Text>
                                <Text style={styles.txt_item}>{item.descrição}</Text>
